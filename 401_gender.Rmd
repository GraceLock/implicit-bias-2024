...
ord_model1 <- polr(scorecat ~ num_tests + politicalid
                           + age + edu + birthSex + race + att_family + att_carerr, 
...
# Fit ordinal logistic regression model
ord_model2 <- polr(scorecat ~ num_tests + politicalid
...
# Fit ordinal logistic regression model
ord_model4 <- polr(scorecat ~ age + birthSex + att_family, 
                  data = genderdata, Hess = TRUE)
...
AICs: 122219.98, 122258.14, 122380.17, 122445.91, 122238.14 (lasso)
