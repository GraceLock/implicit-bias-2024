...
AICs: 123913.36, 123964.44, 124483.70, 124893.51
Ord model 3 has the lowest AIC 
...
```{r}
#table 
ctable <- coef(summary(ord_model3))
```
...
ci <- confint(ord_model3)
ci
```

```{r}
#Odds Ratio and confidence intervals 
exp(cbind(OR = coef(ord_model3), ci))
```
...
# Predict classes
predicted_classes <- predict(ord_model3, newdata = test_data, type = "class")
