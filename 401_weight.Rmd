...
# Fit ordinal logistic regression model
ord_model2 <- polr(scorecat ~ num_tests + politicalid + age + 
...
# Fit ordinal logistic regression model
ord_model3 <- polr(scorecat ~ num_tests 
                             + warmth_thin + warmth_fat + comptomost, 
                  data = weightdata, Hess = TRUE)
...
# Fit ordinal logistic regression model
ord_model4 <- polr(scorecat ~ num_tests 
                             + warmth_thin + warmth_fat, 
                  data = weightdata, Hess = TRUE)
...
AICs: 123913.36, 123964.44, 124483.70, 124893.51, 123900.75 (lasso)
Ord model 5 has the lowest AIC 
Ord model 2 has the highest AIC
